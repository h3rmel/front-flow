interface BlackoutBackgroundProps {
  className?: string;
}

export function BlackoutBackground({ className }: BlackoutBackgroundProps) {
  return (
    <svg
      className={`absolute opacity-30 ${className} -z-50`}
      viewBox="0 0 960 637"
      fill="0"
    ...
    >
      ...
      <g mask="url(#mask0_1_167)">
        ...
        <rect x="518.5" y="120.5" width="79" height="79" fill="white" fillOpacity="0.29" stroke="white"></rect>
        ...
        <rect x="755.5" y="357.5" width="79" height="79" fill="white" fillOpacity="0.25" stroke="white"></rect>
        ...
        <rect x="123.5" y="515.5" width="79" height="79" fill="white" fillOpacity="0.25" stroke="white"></rect>
        ...
        <rect x="834.5" y="515.5" width="79" height="79" stroke="white"></rect>
        <rect x="913.5" y="515.5" width="79" height="79" fill="white" fillOpacity="0.25" stroke="white"></rect>
      </g>
      <defs>
        <filter
          id="filter0_f_1_167"
        ...
        >
          <stop stopColor="#D9D9D9" stopOpacity="0.4"></stop>
